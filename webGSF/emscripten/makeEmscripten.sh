...
OPT="-s DEMANGLE_SUPPORT=0 -s WASM=0 -s ASSERTIONS=0 -s FORCE_FILESYSTEM=1 -Wcast-align -fno-strict-aliasing -s VERBOSE=0 -s SAFE_HEAP=0 -s DISABLE_EXCEPTION_CATCHING=0 -DHAVE_STDINT_H -DNO_DEBUG_LOGS -Wno-pointer-sign -I. -I.. -I../mgba/include  -I../mgba/src -I../../psflib -DHAVE_ZLIB_H -s USE_ZLIB=1"
#OPT2=" -DM_CORE_GB -DM_CORE_GBA -DHAVE_CRC32  -DMINIMAL_CORE=3 -DDISABLE_THREADING ${OPT}"
OPT2=" -DM_CORE_GBA -DHAVE_CRC32  -DMINIMAL_CORE=3 -DDISABLE_THREADING ${OPT}"
#emcc $OPT \
...
#  -o htdocs/gsf.js  -s SINGLE_FILE=0 \
