...
const chipModules = [
  ...
  },
  {
    ...
    exportedFunctions: [
      '_pmd_load_file',
      '_pmd_teardown',
      '_pmd_get_current_position',
      '_pmd_seek_position',
      '_pmd_get_max_position',
      '_pmd_get_track_info',
      '_pmd_get_sample_rate',
      '_pmd_get_audio_buffer',
      '_pmd_get_audio_buffer_length',
      '_pmd_compute_audio_samples',
      '_pmd_has_loop',
      '_pmd_set_rhythm_with_ssg',
      '_pmd_set_usepps',
      '_pmd_get_pcm_filenames',
      '_pmd_reload_pcm',
      '_pmd_get_voices',
      '_pmd_set_voices',
    ],
  ...
  },
  {
    ...
    exportedFunctions: [
      ...
      '_gba_seek_position',
      '_gba_get_max_position',
      '_gba_get_track_info',
      '_gba_get_sample_rate',
      '_gba_get_audio_buffer',
