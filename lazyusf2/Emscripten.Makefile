...
CFLAGS = -c -O3 -Wno-cast-align -fno-strict-aliasing -fno-exceptions -s VERBOSE=0 -s SAFE_HEAP=0 -DEMU_COMPILE -DEMU_LITTLE_ENDIAN -DHAVE_STDINT_H -DNO_DEBUG_LOGS -Wno-pointer-sign -DHAVE_ZLIB_H -s USE_ZLIB=1 -I. $(OPTFLAGS)
