...
sint32 EMU_CALL r3000_execute(void *state, sint32 cycles) {
  ...
  while(STATE->slot || STATE->cycles_remaining > 0) {
    instruction = fetch((struct R3000_STATE*) state);
    if(instruction < 0x04000000) {
      ...
      caseMAJOR(0x10) /* cop0  */
        ...
        break;
      caseMAJOR(0x20) /* lb    */ { a = REGS[INS_S] + SIGNED16(INS_I); d = lb((struct R3000_STATE*) state, a); if(INS_T) { REGS[INS_T] = ((sint32)((sint8)(d)));  } } break;
      caseMAJOR(0x21) /* lh    */ { a = REGS[INS_S] + SIGNED16(INS_I); d = lh((struct R3000_STATE*) state, a); if(INS_T) { REGS[INS_T] = ((sint32)((sint16)(d))); } } break;
      caseMAJOR(0x23) /* lw    */ { a = REGS[INS_S] + SIGNED16(INS_I); d = lw((struct R3000_STATE*) state, a); if(INS_T) { REGS[INS_T] = d;                       } } break;
      caseMAJOR(0x24) /* lbu   */ { a = REGS[INS_S] + SIGNED16(INS_I); d = lb((struct R3000_STATE*) state, a); if(INS_T) { REGS[INS_T] = d & 0x000000FF;          } } break;
      caseMAJOR(0x25) /* lhu   */ { a = REGS[INS_S] + SIGNED16(INS_I); d = lh((struct R3000_STATE*) state, a); if(INS_T) { REGS[INS_T] = d & 0x0000FFFF;          } } break;
      caseMAJOR(0x28) /* sb    */ { a = REGS[INS_S] + SIGNED16(INS_I);     sb((struct R3000_STATE*) state, a, REGS[INS_T] & 0x000000FF); } break;
      caseMAJOR(0x29) /* sh    */ { a = REGS[INS_S] + SIGNED16(INS_I);     sh((struct R3000_STATE*) state, a, REGS[INS_T] & 0x0000FFFF); } break;
      caseMAJOR(0x2B) /* sw    */ { a = REGS[INS_S] + SIGNED16(INS_I);     sw((struct R3000_STATE*) state, a, REGS[INS_T]             ); } break;
      ...
      caseMAJOR(0x22) /* lwl   */
        ...
        { int bitshift;
          for(bitshift = 24;; bitshift -= 8) {
            ...
            REGS[INS_T] |= (((uint32)(lb((struct R3000_STATE*) state, a))) & 0xFF) << bitshift;
            if(!(a&3))break;
            a--;
          }
        }
      ...
      caseMAJOR(0x2A) /* swl   */
        ...
        { int bitshift;
          for(bitshift = 24;; bitshift -= 8) {
            sb((struct R3000_STATE*) state, a, REGS[INS_T]>>bitshift);
            if(!(a&3))break;
            a--;
          }
        }
...
finishing_sync:
  ...
  hw_sync((struct R3000_STATE*) state);
  return 0;
