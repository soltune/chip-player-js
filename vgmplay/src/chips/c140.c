...
UINT8 vgm_c140_r(UINT8 ChipID, offs_t offset)
{
...
void vgm_c140_w(UINT8 ChipID, offs_t offset, UINT8 data)
{
	//c140_state *info = get_safe_token(device);
	c140_state *info = &C140Data[ChipID];
	//info->stream->update();
...
void vgm_c140_set_base(UINT8 ChipID, void *base)
{
	//c140_state *info = get_safe_token(device);
	c140_state *info = &C140Data[ChipID];
	info->pRom = base;
...
void vgm_c140_update(UINT8 ChipID, stream_sample_t **outputs, int samples)
{
...
int vgm_device_start_c140(UINT8 ChipID, int clock, int banking_type)
{
...
void vgm_device_stop_c140(UINT8 ChipID)
{
	c140_state *info = &C140Data[ChipID];
