...
/* Create Object */
EMU2413_API OPLL *_OPLL_new(e_uint32 clk, e_uint32 rate) ;
EMU2413_API void _OPLL_delete(OPLL *) ;

/* Setup */
EMU2413_API void _OPLL_reset(OPLL *) ;
EMU2413_API void _OPLL_reset_patch(OPLL *, e_int32) ;
EMU2413_API void _OPLL_set_rate(OPLL *opll, e_uint32 r) ;
EMU2413_API void _OPLL_set_quality(OPLL *opll, e_uint32 q) ;
EMU2413_API void _OPLL_set_pan(OPLL *, e_uint32 ch, e_int32 pan);

/* Port/Register access */
EMU2413_API void _OPLL_writeIO(OPLL *, e_uint32 reg, e_uint32 val) ;
EMU2413_API void _OPLL_writeReg(OPLL *, e_uint32 reg, e_uint32 val) ;

/* Synthsize */
EMU2413_API e_int16 _OPLL_calc(OPLL *) ;
EMU2413_API void _OPLL_calc_stereo(OPLL *, e_int32 **out, e_int32 samples) ;

/* Misc */
EMU2413_API void _OPLL_setPatch(OPLL *, const e_uint8 *dump) ;
EMU2413_API void _OPLL_copyPatch(OPLL *, e_int32, OPLL_PATCH *) ;
EMU2413_API void _OPLL_forceRefresh(OPLL *) ;
/* Utility */
EMU2413_API void _OPLL_dump2patch(const e_uint8 *dump, OPLL_PATCH *patch) ;
EMU2413_API void _OPLL_patch2dump(const OPLL_PATCH *patch, e_uint8 *dump) ;
EMU2413_API void _OPLL_getDefaultPatch(e_int32 type, e_int32 num, OPLL_PATCH *) ;
...
#define dump2patch _OPLL_dump2patch
