...
#ifdef ENABLE_ALL_CORES
	case EC_MAXIM:
		SN76489_SetMute((SN76489_Context *) info->chip, ~MuteMask & 0x0F);
		break;
#endif
	}
...
#ifdef ENABLE_ALL_CORES
	case EC_MAXIM:
		SN76489_SetPanning((SN76489_Context *) info->chip, PanVals[0x00], PanVals[0x01], PanVals[0x02], PanVals[0x03]);
		break;
#endif
	}
