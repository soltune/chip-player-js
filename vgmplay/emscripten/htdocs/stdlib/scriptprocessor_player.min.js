...
var fetchSamples = function (e) {
    window.player.genSamples.bind(window.player)(e)
}, calcTick = function (e) {
    window.player.tick.bind(window.player)(e)
}, setGlobalWebAudioCtx = function () {
    if (void 0 === window._gPlayerAudioCtx) {
        var t = "Web Audio API is not supported in this browser";
        try {
            "AudioContext" in window ? window._gPlayerAudioCtx = new AudioContext : "webkitAudioContext" in window ? window._gPlayerAudioCtx = new webkitAudioContext : alert(t + e)
        } catch (e) {
            alert(t + e)
        }
    }
...
function extend(e, t, i) {
    for (var a in surrogateCtor.prototype = e.prototype, t.prototype = new surrogateCtor, t.prototype.constructor = t, t.base = e, i) t.prototype[a] = i[a];
    return t
}
...
AbstractTicker = function () {
    ...
    init: function (e, t) {
    }, calcTickData: function (e, t) {
    }, computeAudioSamplesNotify: function () {
    }
};
var SAMPLES_PER_BUFFER = 8192;
AudioBackendAdapterBase = function (e, t) {
    ...
    computeAudioSamples: function () {
    ...
    }, loadMusicData: function (e, t, i, a, r) {
        this.error("loadMusicData")
    }, evalTrackOptions: function (e) {
        this.error("evalTrackOptions")
    }, updateSongInfo: function (e, t) {
        ...
        return !0
    }, mapInternalFilename: function (e, t, i) {
        return (e || t) + i
    }, mapUrl: function (e) {
        return e
        ...
        return -1
    }, getPathAndFilename: function (e) {
        this.error("getPathAndFilename")
    }, registerFileData: function (e, t) {
        this.error("registerFileData")
    }, mapBackendFilename: function (e) {
        return e
    }, mapCacheFileName: function (e) {
        return e
    }, handleBackendSongAttributes: function (e, t) {
        this.error("handleBackendSongAttributes")
    }, mapUri2Fs: function (e) {
        var t = e.replace(/\/\//, "ýý");
        return t = (t = (t = (t = (t = (t = (t = t.replace(/\?/, "ÿ")).replace(/:/, "þ")).replace(/\*/, "ü")).replace(/"/, "û")).replace(/</, "ù")).replace(/>/, "ø")).replace(/\|/, "÷")
    }, mapFs2Uri: function (e) {
        var t = e.replace(/ýý/, "//");
        return t = (t = (t = (t = (t = (t = (t = t.replace(/ÿ/, "?")).replace(/þ/, ":")).replace(/ü/, "*")).replace(/û/, '"')).replace(/ù/, "<")).replace(/ø/, ">")).replace(/÷/, "|")
    }, setObserver: function (e) {
        this._observer = e
    }, notifyAdapterReady: function () {
        void 0 !== this._observer && this._observer.notify()
    }, error: function (e) {
        ...
        var i;
        if (this._sampleRate == this._inputSampleRate) i = this.getCopiedAudio(e, t); else {
            var a = (i = Math.round(t * this._sampleRate / this._inputSampleRate)) * this._channels;
            a > this._resampleBuffer.length && (this._resampleBuffer = this.allocResampleBuffer(a)), this.resampleChannel(0, e, t, i), 2 == this._channels && this.resampleChannel(1, e, t, i)
        }
        return i
    }, resampleChannel: function (e, t, i, a) {
        for (var r, n, s = 0, o = 0, d = a - 0, h = i - 0, l = Math.abs(d - s), c = s < d ? 1 : -1, u = -Math.abs(h - o), f = o < h ? 1 : -1, p = l + u; n = s * this._channels + e, this._resampleBuffer[n] = this.readFloatSample(t, o * this._channels + e), !(s >= d && o >= h);) (r = 2 * p) > u && (p += u, s += c), r < l && (p += l, o += f)
    }, getResampleBuffer: function () {
        return this._resampleBuffer
    }
}, EmsHEAP16BackendAdapter = function () {
    var e = function (t, i) {
        e.base.call(this, i, 2), this.Module = t, this.Module.adapterCallback = function () {
            this.doOnAdapterReady(), this.notifyAdapterReady()
        }.bind(this), window.Math.fround || (window.Math.fround = window.Math.round)
    };
    return extend(AudioBackendAdapterBase, e, {
        doOnAdapterReady: function () {
        }, isAdapterReady: function () {
            return void 0 === this.Module.notReady || !this.Module.notReady
            ...
            var i;
            try {
                i = this.Module.FS_createDataFile(e[0], e[1], t, !0, !0);
...
var ScriptNodePlayer = (PlayerImpl = function (e, t, i, a, r, n, s, o, d) {
    ...
    notify: function () {
        ...
        this.initWebAudio(), this._isPaused = !1, void 0 === this._bufferSource && (this._bufferSource = window._gPlayerAudioCtx.createBufferSource(), this._bufferSource.start || (this._bufferSource.start = this._bufferSource.noteOn, this._bufferSource.stop = this._bufferSource.noteOff), this._bufferSource.start(0))
    }, pause: function () {
        ...
        var e = Math.ceil(SAMPLES_PER_BUFFER / this._tickerStepWidth) - 1;
        return e = Math.min(e, this._currentTick)
    }, setVolume: function (e) {
        void 0 !== this._gainNode && (this._gainNode.gain.value = e)
    }, getVolume: function () {
        return void 0 !== this._gainNode ? this._gainNode.gain.value : -1
    }, isStereo: function () {
        ...
        this._currentPlaytime = 0, this._currentTimeout = e < 0 ? -1 : e / 1e3 * this._sampleRate
    }, getPlaybackTimeout: function () {
        return this._currentTimeout < 0 ? -1 : Math.round(this._currentTimeout / this._sampleRate)
    ...
    }, loadMusicFromTmpFile: function (e, t, i, a, r) {
        var n = e.name, s = (t.basePath ? t.basePath : this._basePath) + n;
        if (!this.loadMusicDataFromCache(s, t, a)) {
            var o = new FileReader;
            o.onload = function () {
                var e = this._backendAdapter.getPathAndFilename(n), r = new Uint8Array(o.result);
                if (void 0 !== this._backendAdapter.registerFileData(e, r)) {
                    var d = this._backendAdapter.mapCacheFileName(s);
                    this.getCache().setFile(d, r), this.prepareTrackForPlayback(s, o.result, t), i(n)
                } else a()
            }.bind(this), o.onprogress = function (e) {
                r && r(e.total, e.loaded)
            }.bind(this), o.readAsArrayBuffer(e)
        }
    }, loadMusicFromURL: function (e, t, i, a, r) {
        var n = this._backendAdapter.mapInternalFilename(t.basePath, this._basePath, e);
        if (!this.loadMusicDataFromCache(n, t, a)) {
            var s = new XMLHttpRequest;
            s.open("GET", this._backendAdapter.mapUrl(n), !0), s.responseType = "arraybuffer", s.onload = function (e) {
                this.trace("loadMusicFromURL successfully loaded: " + n), this.prepareTrackForPlayback(n, s.response, t) ? i(n) : this.isWaitingForFile() || a()
            }.bind(this), s.onprogress = function (e) {
                r && r(e.total, e.loaded)
            }.bind(this), s.onreadystatuschange = function (e) {
                4 == oReq.readyState && 404 == oReq.status && this.trace("loadMusicFromURL failed to load: " + n)
            }.bind(this), s.send(null)
        }
    }, uploadFile: function (e, t, i, a, r) {
        var n = new FileReader;
        n.onload = function () {
            var r = this._backendAdapter.getPathAndFilename(e.name), s = new Uint8Array(n.result);
            if (void 0 !== this._backendAdapter.registerFileData(r, s)) {
                var o = this._backendAdapter.uploadFile(e.name, t);
                0 === o ? (i(e.name), this._onPlayerReady()) : 1 == o && i(e.name)
            } else a()
        }.bind(this), n.onprogress = function (e) {
            r && r(e.total, e.loaded)
        }.bind(this), n.readAsArrayBuffer(e)
        ...
        var a = this.loadMusicData(e, t, i);
        if (a < 0) this._isSongReady = !1, this.setWaitingForFile(!0), this._initInProgress = !1; else {
            if (0 === a) return this.setWaitingForFile(!1), this._isSongReady = !0, this._currentPlaytime = 0, this._initInProgress = !1, this.trace("successfully completed init"), 0 !== this._backendAdapter.evalTrackOptions(i) ? (this.trace("error preparing track options"), !1) : (this.updateSongInfo(e), this._onTrackReadyToPlay(), this._isPaused = !1, !0);
            this._initInProgress = !1, this.trace("initIfNeeded - fatal error")
        }
        return !1
    }, loadMusicDataFromCache: function (e, t, i) {
        this._currentTimeout = -1, this._currentPlaytime = 0, this._isPaused = !0;
        var a = this._backendAdapter.mapCacheFileName(e), r = this.getCache().getFile(a);
        return void 0 !== r && (this.prepareTrackForPlayback(e, r, t) || this.isWaitingForFile() || i(), !0)
    }, initWebAudio: function () {
        if (void 0 !== this._bufferSource) try {
            this._bufferSource.stop(0)
        } catch (e) {
        } else this._analyzerNode = window._gPlayerAudioCtx.createAnalyser(), this._scriptNode = this.createScriptProcessor(window._gPlayerAudioCtx), this._gainNode = window._gPlayerAudioCtx.createGain(), this._scriptNode.connect(this._gainNode), void 0 !== this._externalTicker && this.createTickerScriptProcessor(window._gPlayerAudioCtx).connect(this._gainNode), this._spectrumEnabled ? (this._gainNode.connect(this._analyzerNode), this._analyzerNode.connect(window._gPlayerAudioCtx.destination)) : this._gainNode.connect(window._gPlayerAudioCtx.destination)
    }, updateSongInfo: function (e) {
        this._songInfo = {}, this._backendAdapter.updateSongInfo(e, this._songInfo)
    }, loadMusicData: function (e, t, i) {
        if (this._backendAdapter.teardown(), t) {
            var a = this._backendAdapter.getPathAndFilename(e), r = new Uint8Array(t);
            this._backendAdapter.registerFileData(a, r);
            var n = this._backendAdapter.mapCacheFileName(e);
            this.getCache().setFile(n, r);
            var s = this._backendAdapter.loadMusicData(this._sampleRate, a[0], a[1], r, i);
            return 0 === s && this.resetBuffer(), s
        }
    ...
    }, createTickerScriptProcessor: function (e) {
        var t;
        return (t = e.createScriptProcessor(256, 0, 1)).onaudioprocess = calcTick, t
    }, fillEmpty: function (e, t, a) {
        var r = e - this._numberOfSamplesRendered;
        for (i = 0; i < r; i++) t[i + this._numberOfSamplesRendered] = 0, this.isStereo() && (a[i + this._numberOfSamplesRendered] = 0);
        ...
        var t = this._backendAdapter.mapBackendFilename(e), i = this._backendAdapter.mapCacheFileName(t);
        return this.getCache().getFile(i).length
        ...
        if (void 0 !== r) {
            var n = 0;
            return 0 == r && (n = 1, this.trace("error: preloadFile could not get cached: " + e)), i && t(), n
        }
        if (this._isPaused = !0, this.setWaitingForFile(!0), this._isSongReady = !1, !(a in this.getCache().getPendingMap())) {
            this.getCache().getPendingMap()[a] = 1;
            var s = new XMLHttpRequest;
            s.open("GET", this._backendAdapter.mapUrl(e), !0), s.responseType = "arraybuffer", s.onload = function (i) {
                var r = s.response;
                if (r) {
                    this.trace("preloadFile successfully loaded: " + e);
                    var n = this._backendAdapter.getPathAndFilename(e), o = new Uint8Array(r);
                    this._backendAdapter.registerFileData(n, o), this.getCache().setFile(a, o)
                }
                delete this.getCache().getPendingMap()[a] || this.trace("remove file from pending failed: " + a), t()
            }.bind(this), s.onreadystatuschange = function (t) {
                4 == s.readyState && 404 == s.status && (this.trace("preloadFile failed to load: " + e), this.getCache().setFile(a, 0))
            }.bind(this), s.onerror = function (e) {
                this.getCache().setFile(a, 0)
            }.bind(this), s.send(null)
        }
        return -1
    }, tick: function (e) {
        ...
        if (this.isStereo() && (t = e.outputBuffer.getChannelData(1)), !this._isSongReady || this.isWaitingForFile() || this._isPaused) {
            ...
            for (this._numberOfSamplesRendered = 0; this._numberOfSamplesRendered < r;) {
                ...
                this.isStereo() ? this.copySamplesStereo(s, i, t, r) : this.copySamplesMono(s, i, t, r)
            }
            this._currentPlaytime += r
        }
        void 0 !== this._externalTicker && (this._externalTicker.calcTickData(i, t), this._currentTick = 0)
    }, copySamplesStereo: function (e, t, i, a) {
        var r;
        if (this._numberOfSamplesRendered + this._numberOfSamplesToRender > a) {
            var n = a - this._numberOfSamplesRendered;
            for (r = 0; r < n; r++) t[r + this._numberOfSamplesRendered] = e[this._sourceBufferIdx++], i[r + this._numberOfSamplesRendered] = e[this._sourceBufferIdx++];
            this._numberOfSamplesToRender -= n, this._numberOfSamplesRendered = a
        } else {
            for (r = 0; r < this._numberOfSamplesToRender; r++) t[r + this._numberOfSamplesRendered] = e[this._sourceBufferIdx++], i[r + this._numberOfSamplesRendered] = e[this._sourceBufferIdx++];
        ...
        if (this._numberOfSamplesRendered + this._numberOfSamplesToRender > a) {
            var n = a - this._numberOfSamplesRendered;
            for (r = 0; r < n; r++) t[r + this._numberOfSamplesRendered] = e[this._sourceBufferIdx++];
            this._numberOfSamplesToRender -= n, this._numberOfSamplesRendered = a
        } else {
            for (r = 0; r < this._numberOfSamplesToRender; r++) t[r + this._numberOfSamplesRendered] = e[this._sourceBufferIdx++];
            this._numberOfSamplesRendered += this._numberOfSamplesToRender, this._numberOfSamplesToRender = 0
        }
    }, preloadFiles: function (e, t) {
        this._isPaused = !0, this._backendAdapter.isAdapterReady() ? this.preload(e, e.length, t) : this.deferredPreload = [e, t]
    }, setWaitingForFile: function (e) {
        this.getCache().setWaitingForFile(e)
    }, isWaitingForFile: function () {
        return this.getCache().isWaitingForFile()
    }, getCache: function () {
        return void 0 === window._fileCache && (window._fileCache = new FileCache), window._fileCache
    }
}, {
    createInstance: function (e, t, i, a, r, n, s, o, d) {
        var h = !1;
        if (void 0 !== window.player) {
            var l = window.player;
            l._isPaused = !0, void 0 !== l._bufferSource && l._bufferSource.stop(0), l._scriptNode && l._scriptNode.disconnect(0), l._analyzerNode && l._analyzerNode.disconnect(0), l._gainNode && l._gainNode.disconnect(0), h = l._traceSwitch
        }
        new PlayerImpl(e, t, i, a, r, n, s, o, d)._traceSwitch = h
    }, getInstance: function () {
        return void 0 === window.player && alert("fatal error: window.player not defined"), window.player
    }
});